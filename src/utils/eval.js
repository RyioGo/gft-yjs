...
function goToEvaluation() {
  let params = `appCode=${hwappCode}&appName=${hwappName}&regionCode=${hwregionCode}&regionName=${hwregionName}&abilityCode=${hwabilityCode}&organCode=${hworganCode}`;
  window.location.href =
    "https://ganfutong.jiangxi.gov.cn/jmopen/webapp/html5/gfttyfwpj/index.html?" +
    params;
  /*  hw.jumpToEvaluate({
	    // abilityCode:'0272a09bed4140f2844579aacf01ef4f',
	    // organCode:'6b256507c68844a4a25f62c4b9488810',
	    appCode: hwappCode,
	    appName: hwappName,
